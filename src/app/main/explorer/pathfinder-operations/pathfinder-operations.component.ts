...
@Component({
  selector: 'app-pathfinder-operations',
  templateUrl: './pathfinder-operations.component.html',
  styleUrls: ['./pathfinder-operations.component.scss'],
})
export class PathfinderOperationsComponent implements OnDestroy, OnInit {
  data = [];
