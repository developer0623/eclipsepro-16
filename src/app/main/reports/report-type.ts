import { IJobSummaryDto, IMaterialDoc } from 'src/app/core/dto';
...
export type DowntimeCodeDef = {
  code: number;
  category: 'None' | 'Change' | 'Breakdown' | 'OtherExpected' | 'OtherUnexpected' | 'Unscheduled';
  description: string;
};
