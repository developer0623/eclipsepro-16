...
import { ToolingUsageReportModel, FilterState, DurationType } from '../report-type';
...
@Component({
  selector: 'app-tooling-usage',
  templateUrl: './tooling-usage.component.html',
  styleUrls: ['./tooling-usage.component.scss'],
  animations: [
...
export class ToolingUsageComponent implements OnInit, OnDestroy {
  summaryList: ToolingUsageReportModel = {} as ToolingUsageReportModel;
    ...
    reportFilterSubject$
      .pipe(
        ...
        map((filters) => {
          ...
          return this.http.get(`${Ams.Config.BASE_URL}/_api/reports/toolingUsage`, {
            params: query,
          });
        }),
        switchMap((source) => source)
      )
      .subscribe((summaryList: ToolingUsageReportModel) => {
