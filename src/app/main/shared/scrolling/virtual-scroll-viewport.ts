...
@Component({
  selector: 'custom-cdk-virtual-scroll-viewport',
  templateUrl: 'virtual-scroll-viewport.html',
  styleUrls: ['virtual-scroll-viewport.scss'],
  host: {
    class: 'custom-cdk-virtual-scroll-viewport cdk-virtual-scroll-orientation-vertical',
  },
  ...
  providers: [
    {
      ...
      useFactory: (
        ...
        viewport: CustomCdkVirtualScrollViewport
      ) => virtualScrollable || viewport,
      deps: [[new Optional(), new Inject(VIRTUAL_SCROLLABLE)], CustomCdkVirtualScrollViewport],
    },
  ],
})
export class CustomCdkVirtualScrollViewport
  ...
  implements OnInit, OnDestroy
{
  ...
  constructor(
    ...
    if (!_scrollStrategy && (typeof ngDevMode === 'undefined' || ngDevMode)) {
      throw Error(
        'Error: custom-cdk-virtual-scroll-viewport requires the "itemSize" property to be set.'
      );
    }
  ...
  attach(forOf: CdkVirtualScrollRepeater<any>) {
    if (this._forOf && (typeof ngDevMode === 'undefined' || ngDevMode)) {
      throw Error('CustomCdkVirtualScrollViewport is already attached.');
    }
  ...
  measureRangeSize(range: ListRange): number {
    ...
    return this._forOf.measureRangeSize(range);
  }
