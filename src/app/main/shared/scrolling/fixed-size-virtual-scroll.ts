...
export class FixedSizeVirtualScrollStrategy implements VirtualScrollStrategy {
  ...
  private _viewport: CustomCdkVirtualScrollViewport | null = null;
  ...
  private _updateRenderedRange(isCheck = false) {
    if (!this._viewport) {
      return;
    }
...
@Directive({
  selector: 'custom-cdk-virtual-scroll-viewport[itemSize]',
  standalone: true,
  providers: [
    {
