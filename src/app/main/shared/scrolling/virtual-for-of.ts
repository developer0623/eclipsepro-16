...
export type CdkVirtualForOfContext<T> = {
  ...
  customCdkVirtualForOf: DataSource<T> | Observable<T[]> | NgIterable<T>;
 ...
 */
@Directive({
  selector: '[customCdkVirtualFor][customCdkVirtualForOf]',
  ...
  implements CdkVirtualScrollRepeater<T>, CollectionViewer, DoCheck, OnDestroy
{
  ...
  private readonly _needsUpdate$ = new Subject<boolean>();

  /** The DataSource to display. */
  @Input()
  get customCdkVirtualForOf(): DataSource<T> | Observable<T[]> | NgIterable<T> | null | undefined {
    return this._cdkVirtualForOf;
  }
  set customCdkVirtualForOf(
   ...
   */
  @Input()
  get customCdkVirtualForTrackBy(): TrackByFunction<T> | undefined {
    return this._cdkVirtualForTrackBy;
  }
  set customCdkVirtualForTrackBy(fn: TrackByFunction<T> | undefined) {
  ...
  @Input()
  set customCdkVirtualForTemplate(value: TemplateRef<CdkVirtualForOfContext<T>>) {
    if (value) {
      // this._needsUpdate = true;
      this._needsUpdate$.next(true);
   ...
   */
  @Input()
  get customCdkVirtualForTemplateCacheSize(): number {
    return this._viewRepeater.viewCacheSize;
  }
  set customCdkVirtualForTemplateCacheSize(size: NumberInput) {
  ...
  constructor(
    ...
    @SkipSelf() private _viewport: CustomCdkVirtualScrollViewport,
    ngZone: NgZone
  ) {
  ...
  /**
   * Measures the combined size (height for vertical) of all items
  ...
  private _onRenderedDataChange() {
    ...
    if (!this._differ) {
      ...
      this._differ = this._differs.find(this._renderedItems).create((index, item) => {
        return this.customCdkVirtualForTrackBy
          ? this.customCdkVirtualForTrackBy(index, item)
          : item;
      });
    }
    // this._needsUpdate = true;
  ...
  private _getEmbeddedViewArgs(
    ...
    return {
      ...
      context: {
        ...
        customCdkVirtualForOf: this._cdkVirtualForOf!,
        index: -1,
        count: -1,
        first: false,
        last: false,
